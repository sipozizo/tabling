...
import sipozizo.tabling.common.lock.service.RedisLockService;
...
//        원자적 증가 연산('INCR' 명령) 사용
    ...
    public void updateReservationStatus(Long reservationId, ReservationStatus status) {
        ...
        redisLockService.executeWithLock(lockKey, () -> reservationUpdateServiceV2.updateStatus(reservationId, status));
    }
