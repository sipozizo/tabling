...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, StoreDto> storeRedisTemplate(RedisConnectionFactory connectionFactory) {
        RedisTemplate<String, StoreDto> template = new RedisTemplate<>();
        template.setConnectionFactory(connectionFactory);
